...
exports.getBlogPostPrompt = getBlogPostPrompt;
exports.getSocialMediaPrompt = getSocialMediaPrompt;
exports.getEmailMarketingPrompt = getEmailMarketingPrompt;
exports.getAdCopyPrompt = getAdCopyPrompt;
exports.getCampaignStrategyPrompt = getCampaignStrategyPrompt;
exports.getCampaignIdeasPrompt = getCampaignIdeasPrompt;
exports.detectContentTypeAndGetPrompt = detectContentTypeAndGetPrompt;
/**
 * Blog post generation prompt
 */
function getBlogPostPrompt(brandContext) {
 ...
 */
function getSocialMediaPrompt(platform, brandContext) {
 ...
 */
function getEmailMarketingPrompt(brandContext) {
 ...
 */
function getAdCopyPrompt(brandContext) {
 ...
 */
function getCampaignStrategyPrompt(brandContext) {
 ...
 */
function getCampaignIdeasPrompt(brandContext) {
 ...
 */
function formatBrandContext(brandContext) {
 ...
 */
function detectContentTypeAndGetPrompt(userMessage, brandContext) {
