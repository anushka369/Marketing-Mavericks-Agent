...
exports.validateBlogPostStructure = validateBlogPostStructure;
exports.validateEmailStructure = validateEmailStructure;
exports.validateAdCopyStructure = validateAdCopyStructure;
exports.validateCampaignStrategyStructure = validateCampaignStrategyStructure;
exports.validateCampaignIdeasStructure = validateCampaignIdeasStructure;
exports.validateSocialMediaLength = validateSocialMediaLength;
/**
 * Validate blog post structure
 * Requirements: Must have title, introduction, body sections, and conclusion
 */
function validateBlogPostStructure(content) {
 ...
 */
function validateEmailStructure(content) {
    const missingComponents = [];
 ...
 */
function validateAdCopyStructure(content) {
    const missingComponents = [];
    const errors = [];
    // Count variations
 ...
 */
function validateCampaignStrategyStructure(content) {
    const missingComponents = [];
 ...
 */
function validateCampaignIdeasStructure(content) {
    const errors = [];
    const missingComponents = [];
 ...
 */
function validateSocialMediaLength(content, platform) {
