 ...
 */
function buildSystemPrompt(userMessage, brandContext) {
    // Try to detect specific content type and use specialized prompt
    const specializedPrompt = (0, prompts_1.detectContentTypeAndGetPrompt)(userMessage, brandContext);
 ...
 */
async function generateContent(userMessage, conversationHistory = [], brandContext, maxRetries = 3) {
